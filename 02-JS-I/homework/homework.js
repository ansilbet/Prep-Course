...
function tienenMismaLongitud(str1, str2) {
  ...
  if (long1==long2){return true;}{return false;}
}
...
function esPar(num) {
  ...
  // Tu código:
  var par=num%2;
if(par==0){return true;}{return false;}  
}
...
function esPositivo(numero) {
  ...
  if (numero==0){return false;}{if(numero>0){return 'Es positivo';}{return 'Es negativo';}}
}
...
function esVocal(letra){
  ...
  if(long>1){return 'Dato incorrecto'}
  {
